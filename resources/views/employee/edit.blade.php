                    ...
                    <div class="p-5 bg-light rounded-3 col-xl-6">
                        ...
                        <div class="row">
                            <div class="col-md-6 d-grid">
                                <a href="{{ route('employees.index') }}" class="btn btn-outline-dark btn-lg mt-2"><i class="bi-arrow-left-circle me-1"></i> Cancel</a>
                            </div>
                            <div class="col-md-6 d-grid">
                                <button type="submit" class="btn btn-dark btn-lg mt-1"><i class="bi-check-circle me-2"></i> Edit</button>
                            </div>
                        </div>
                    </div>
                </div>
